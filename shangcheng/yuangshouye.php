...
<ul>
  ...
  <hr>
  <li><a class="active" href="#yuangshouye.php"><h5 align="center">商品管理</h5></a></li>
  <hr>
...
<?php 
 ...
 $pageSize = 8;//每页显示3行数据
    ...
    $sql = "select count(id) from tb_shangpin";
    ...
    //显示某页 员工数据信息条
    $sql = "select * from tb_shangpin order by id limit ".($pageNow-1)*$pageSize.",$pageSize";//注意limit后面要有空格

  

    $res =mysqli_query($conn,$sql);
    echo "<table border= '1px' align='center'>";
    echo "<th>序号</th><th>商品名称</th><th>商品价格</th><th>上市时间</th><th>操作</th><th>操作</th><th>操作</th></tr>";
  ...
  while ($a2=mysqli_fetch_row($res)) {
    ...
    <td><a href=shangpinxiugai.php?action=update&id=".$a2[0].">修改</td>
    <td><a href=shangpinoper.php?action=del&id=".$a2[0]." onclick='return del()'>删除</td>
    <td><a href=shangpinxiang.php?action=select&id=".$a2[0].">详情</td>
